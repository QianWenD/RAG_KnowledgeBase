 ...
 * 菜单：限定规则-1
 * @Last Modified time: 2020-01-09 15:31:24
 */
...
<template>
  <div>
    ...
    <kindo-box title="限价规则-1">
      <kindo-table ref="parent" :url="parent.url" :queryParam="parent.search" :pageSize="5" :extendOption="extend"
        ...
        <el-table-column label="单位" prop="itemUnit"
          ...
          show-overflow-tooltip></el-table-column>
        <el-table-column label="市级一级" prop="cityLevel1" :formatter="(r,c,v) => kindo.util.formatNum(v,2)" width="100"
          header-align="center" align="right" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="市级二级" prop="cityLevel2" :formatter="(r,c,v) => kindo.util.formatNum(v,2)" width="100"
          header-align="center" align="right" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="市级三级" prop="cityLevel3" :formatter="(r,c,v) => kindo.util.formatNum(v,2)" width="100"
          header-align="center" align="right" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="县级一级" prop="countyLevle1" :formatter="(r,c,v) => kindo.util.formatNum(v,2)" width="100"
          header-align="center" align="right" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="县级二级" prop="countyLevle2" :formatter="(r,c,v) => kindo.util.formatNum(v,2)" width="100"
          header-align="center" align="right" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="县级三级" prop="countyLevle3" :formatter="(r,c,v) => kindo.util.formatNum(v,2)" width="100"
          header-align="center" align="right" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="非公立一级" prop="nonPublicLevel1" :formatter="(r,c,v) => kindo.util.formatNum(v,2)"
          width="120" header-align="center" align="right" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="非公立二级" prop="nonPublicLevel2" :formatter="(r,c,v) => kindo.util.formatNum(v,2)"
          width="120" header-align="center" align="right" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="非公立三级" prop="nonPublicLevel3" :formatter="(r,c,v) => kindo.util.formatNum(v,2)"
          width="120" header-align="center" align="right" sortable='custom' show-overflow-tooltip></el-table-column>
    ...
    <el-dialog v-drag top="0" :visible.sync="parent.dialog.visible" :title="`${parent.form.id?'编辑':'新增'}限价规则`"
      ...
      <el-form :model="parent.form" :rules="parent.rules" class="box" onsubmit="return false;" label-width="100px"
        :ref="parent.ref">
        ...
        <el-form-item label="市级一级" prop="cityLevel1">
          <el-input-number v-model="parent.form.cityLevel1" :precision="2" :max="990000" :controls="false">
          </el-input-number>
        </el-form-item>
        <el-form-item label="市级二级" prop="cityLevel2">
          <el-input-number v-model="parent.form.cityLevel2" :precision="2" :max="990000" :controls="false">
          </el-input-number>
        </el-form-item>
        <el-form-item label="市级三级" prop="cityLevel3">
          <el-input-number v-model="parent.form.cityLevel3" :precision="2" :max="990000" :controls="false">
          </el-input-number>
        </el-form-item>
        <el-form-item label="县级一级" prop="countyLevle1">
          <el-input-number v-model="parent.form.countyLevle1" :precision="2" :max="990000" :controls="false">
          </el-input-number>
        </el-form-item>
        <el-form-item label="县级二级" prop="countyLevle2">
          <el-input-number v-model="parent.form.countyLevle2" :precision="2" :max="990000" :controls="false">
          </el-input-number>
        </el-form-item>
        <el-form-item label="县级三级" prop="countyLevle3">
          <el-input-number v-model="parent.form.countyLevle3" :precision="2" :max="990000" :controls="false">
          </el-input-number>
        </el-form-item>
        <el-form-item label="非公立一级" prop="nonPublicLevel1">
          <el-input-number v-model="parent.form.nonPublicLevel1" :precision="2" :max="990000" :controls="false">
          </el-input-number>
        </el-form-item>
        <el-form-item label="非公立二级" prop="nonPublicLevel2">
          <el-input-number v-model="parent.form.nonPublicLevel2" :precision="2" :max="990000" :controls="false">
          </el-input-number>
        </el-form-item>
        <el-form-item label="非公立三级" prop="nonPublicLevel3">
          <el-input-number v-model="parent.form.nonPublicLevel3" :precision="2" :max="990000" :controls="false">
          </el-input-number>
        </el-form-item>
