  ...
  <div>
    ...
    <kindo-box title="检验合理次数规则">
      <kindo-table ref="table" :url="table.url" :queryParam="search" :default-sort="tableSort" @selection-change="(selection) => selectionChange(selection, 'selection')" @filter-change="(filters)=>filterChange(filters,'table', 'search')">
        ...
        <el-table-column label="单位" prop="unitName" width="90" align="center" header-align="center" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="每日上限次数" prop="itemNum" width="140" align="center" header-align="center" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="住院上限次数" prop="limitNum" width="140" align="center" header-align="center" sortable='custom' show-overflow-tooltip></el-table-column>
    ...
    <el-dialog v-drag top="0" :visible.sync="visible" :title="(form.id?'编辑':'新增') +'诊疗项目'" :modal-append-to-body="false" :close-on-click-modal="false">
      <el-form :model="form" label-position="right" ref="form" class="box" label-width="120px" :rules="formRules">
        ...
        <el-form-item label="每日上限次数" prop="itemNum">
          <el-input-number :controls="false" :min="0" :max="99" v-model.trim="form.itemNum"></el-input-number>
        </el-form-item>
        <el-form-item label="住院上限次数" prop="limitNum">
          <el-input-number :controls="false" :min="0" :max="99" v-model.trim="form.limitNum"></el-input-number>
        </el-form-item>
