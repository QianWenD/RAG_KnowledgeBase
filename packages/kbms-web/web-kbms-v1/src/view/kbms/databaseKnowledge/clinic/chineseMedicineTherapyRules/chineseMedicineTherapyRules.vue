...
<template>
  <div>
    ...
    <el-dialog v-drag top="0" :visible.sync="visible" :title="(form.id?'编辑':'新增') +'中医疗法'" :modal-append-to-body="false" :close-on-click-modal="false">
...
export default {
  name: 'chineseMedicineTherapyRules',
  mixins: [mixin],
  data() {
