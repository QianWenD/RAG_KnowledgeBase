  ...
  <div>
    ...
    <kindo-box title="项目联用收费限定规则">
      <kindo-table ref="parent" :url="parent.url" :queryParam="parent.search" :extendOption="extend"
        ...
        :default-sort="parent.sort" :pageSize="5">
        <el-table-column type="selection" fixed="left" width="30"></el-table-column>
        <el-table-column label="诊疗项目编码" fixed="left" prop="itemCode" width="140" header-align="center" sortable='custom'
          show-overflow-tooltip></el-table-column>
        <el-table-column label="诊疗项目名称" fixed="left" prop="itemName" width="160" header-align="center" sortable='custom'
          show-overflow-tooltip></el-table-column>
        <el-table-column label="项目内涵" prop="itemIntension" min-width="200" header-align="center" show-overflow-tooltip>
        </el-table-column>
    ...
    <kindo-box title="查询条件" icon="xx">
      ...
      <div slot="control">
        <el-button icon="el-icon-search" type="primary" :disabled="child.search.itemRepeatId === ''?true:false"
    ...
    <kindo-box title="项目联用收费限定规则">
      <kindo-table ref="child" :url="child.url" :queryParam="child.search" :extendOption="extend"
        ...
        @filter-change="(filters)=>filterChange(filters,'child',child.search)" :default-sort="child.sort" :pageSize="5">
        <el-table-column type="selection" fixed="left" width="30"></el-table-column>
        <el-table-column label="诊疗项目编码" fixed="left" prop="itemCode" width="140" header-align="center" sortable='custom'
          show-overflow-tooltip></el-table-column>
        <el-table-column label="诊疗项目名称" fixed="left" prop="itemName" width="160" header-align="center" sortable='custom'
      ...
      <div slot="control">
        <el-button icon="el-icon-plus" type="text" :disabled="child.search.itemRepeatId === ''?true:false"
          @click="insert('child')">新增</el-button>
        <el-button icon="el-icon-delete" type="text" :disabled="child.search.itemRepeatId === ''?true:false"
          @click="remove('child')">删除</el-button>
        <el-button icon="el-icon-view" type="text" :disabled="child.search.itemRepeatId === ''?true:false"
    ...
    <!-- 主表新增 start -->
    <el-dialog v-drag top="0" :visible.sync="parent.dialog.visible" :title="(parent.form.id?'编辑':'新增') + '探查术'"
