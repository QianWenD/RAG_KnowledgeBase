  ...
  <div>
    ...
    <kindo-box title="中药饮片超量规则">
      <kindo-table ref="table" :url="table.url" :queryParam="search" @selection-change="(selection) => selectionChange(selection, 'selection')" @filter-change="(filters)=>filterChange(filters,'table', 'search')">
        ...
        <el-table-column label="中药饮片编码" prop="drugCode" min-width="140" header-align="center" sortable='custom' show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="处方限定用量(g)" prop="preDosage" width="160" align="right" header-align="center" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="每天用量(g)" prop="dayDosage" width="140" align="right" header-align="center" sortable='custom' show-overflow-tooltip></el-table-column>
        <el-table-column label="政策法规" prop="remark" width="120" header-align="center" sortable='custom' show-overflow-tooltip></el-table-column>
    ...
    <el-dialog v-drag top="0" :visible.sync="visible" :title="(form.id?'编辑':'新增') +'中药饮片超量规则'" :modal-append-to-body="false" :close-on-click-modal="false">
      <el-form :model="form" label-position="right" ref="form" class="box" label-width="130px" :rules="formRules">
        ...
        <el-form-item label="处方限定用量(g)" prop="preDosage">
          <el-input v-model.trim="form.preDosage"></el-input>
        </el-form-item>
        <el-form-item label="每日用量(g)" prop="dayDosage">
          <el-input v-model.trim="form.dayDosage" size="mini"></el-input>
        </el-form-item>
        <el-form-item label="政策法规" prop="remark">
