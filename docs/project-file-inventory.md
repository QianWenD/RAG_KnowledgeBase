...
补充入口：`apps/README.md` 已说明 `api`、`web`、`worker` 的职责边界。
...
补充入口：`src/ragpro/README.md` 已说明正式 Python 包的模块分区。
...
补充入口：`tests/README.md` 已说明测试分区和常用命令。
...
补充入口：`packages/README.md` 已说明数据资产、历史原型和旧前端参考的边界。
...
- 中文化关键文档。
- 在文档里明确主线、参考区、运行产物。
- 参考 `docs/repository-cleanup-plan.md` 做清理和归档决策。
